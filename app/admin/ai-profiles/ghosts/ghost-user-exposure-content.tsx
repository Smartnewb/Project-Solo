...
export const GHOST_NOT_TRACKABLE = 'Ghost user is not trackable';

export const PATH_LABELS: Record<UserGhostExposurePath, string> = {
	v4_fallback: 'V4 폴백',
			...
			<div className="flex items-center gap-1 flex-shrink-0">
				{item.connectionId && (
					<a
						...
						target="_blank"
						rel="noreferrer"
						className="h-7 w-7 flex items-center justify-center rounded hover:bg-gray-100 text-gray-400 hover:text-gray-600"
						title="매칭 상세 보기"
					>
...
interface GhostUserExposureContentProps {
	userId: string;
	onGhostSelect: (ghostAccountId: string) => void;
}

export function GhostUserExposureContent({
	userId,
	onGhostSelect,
