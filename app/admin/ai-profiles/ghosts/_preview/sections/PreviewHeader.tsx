		...
		<div className="flex items-center justify-between px-4 py-3">
			...
			<div className="flex items-center gap-2">
				<div className="flex items-center gap-1 rounded-full bg-[#ffd1da] px-3 py-1.5 text-xs">
					<Gem className="h-3.5 w-3.5 text-[#ff385c]" />
					<span className="text-[9px] font-medium text-[#ff385c]">내 구슬</span>
					<span className="text-[13px] font-extrabold text-[#e00b41]">0개</span>
				</div>
