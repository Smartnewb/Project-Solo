...
export default function Profile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showTemporaryModal('이상형 정보가 성공적으로 저장되었습니다.', 'success');
      router.push('/home');
    } catch (error) {
      ...
      showTemporaryModal('이상형 정보 저장 중 오류가 발생했습니다.', 'error');
    } finally {
      setIsSaving(false);
    }
  };
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="bg-white rounded-2xl shadow-sm p-8">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">이상형 정보 설정</h1>
          </div>
